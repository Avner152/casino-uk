...
const PortalSection = observer(({ captchaToken }) => {
  ...
  useEffect(() => {
    ...
    const ENDPOINT = `${process.env.REACT_APP_SERVER_URI}/winchester/prd?product=${myStore.product}`;
    // const ENDPOINT = `http://localhost:5001/winchester/prd?product=${myStore.product}`;
