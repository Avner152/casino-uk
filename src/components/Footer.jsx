...
export default function Footer() {
  ...
  return (
    <footer className={`w-100 _p-${isMobile ? "0 pb-5" : 5}`}>
      <div
      ...
      >
        <div className="footer-logo d-flex flex-column flex-grow-0">
          ...
          <div>
            <p>
              Are you looking for the best casino games and the biggest bonuses
              on the market? CasinoCompare is looking out for you. We have tried
              and tested most casinos on the Canadian market so you have the
              choice of only the most trustworthy and fun places to bet your
              money. Keep up with our news and updates to make the most of your
              online casino experience!
            </p>
          </div>
        </div>

        <div className="footer-foo d-flex gap-5 flex-grow-1 justify-content-around">
          {footer.map((footerItem, _) => (
            <div key={footerItem.title} className="d-flex flex-column gap-2">
      ...
      <div className="w-75 m-auto text-center ">
        ...
        organization number: C53144 and is completely independent of the gaming
        companies. Please note that third parties reserve the right to change or
        remove bonuses / promotions at short notice. canadacasino.ca can
        therefore not be held responsible for any incorrect information. Always
        read the terms and conditions of the bonus at each casino carefully
        before playing.
      </div>
