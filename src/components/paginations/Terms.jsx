...
export default function Terms() {
  ...
  const meta = {
    title: "Terms and Conditions  | UK Best Casino",
    description:
      "Read the Terms and Conditions for using UK Best Casino's website and services. Learn about your rights, obligations, and the rules governing your use of our site",
  };
  return (
    <>
      <Helmet>
