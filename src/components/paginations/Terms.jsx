...
export default function Terms() {
  ...
  const meta = {
    title: "Terms and Conditions  | Play UK Casinos",
    description:
      "Read the Terms and Conditions for using Play UK Casinos's website and services. Learn about your rights, obligations, and the rules governing your use of our site",
  };
  return (
    <>
      <Helmet>
