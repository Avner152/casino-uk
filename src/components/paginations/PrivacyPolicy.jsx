      ...
      <div className="_w-100 text-bg-dark text-white pt-5 pb-5 mt-3 information">
        <div className="m-auto pt-3">
          ...
          <p>
            Website:{" "}
            <a
              href="https://www.ukcasinonova.com/"
              className="text-white"
              target="_blank"
              rel="noreferrer"
            >
              https://www.ukcasinonova.com/
            </a>
          </p>
          <p>
            ...
            visit www.ukcasinonova.com (the &quot;Website&quot;). This document
              ...
              <table className="table table-dark table-bordered align-middle mb-0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a
                        href="mailto:privacy@ukcasinonova.com"
                        className="text-white"
                      >
                        privacy@ukcasinonova.com
                      </a>
                    </td>
                  </tr>
                </tbody>
          ...
          <div className="mt-4">
            ...
            <p>
              UKCasinoNova.com is an independent affiliate comparison portal and
          ...
          <div className="mt-4">
            ...
            <p>
              ...
              <a href="mailto:privacy@ukcasinonova.com" className="text-white">
                privacy@ukcasinonova.com
              </a>
